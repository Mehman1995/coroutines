...
suspend fun getComments(client: OkHttpClient, idPost: Long): List<Comment> =
    makeRequest("$BASE_URL/api/slow/posts/$idPost/comments", client, object : TypeToken<List<Comment>>() {})
